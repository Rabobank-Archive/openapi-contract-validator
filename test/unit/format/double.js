...
const format = require('../../../src/format/double');
...
bundle('OAS format', function() {
    describe('double', function() {
        ...
        it('has the correct name', function() {
            ...
            expect(names).to.deep.equal(['double'].sort());
        });
        ...
        it('matches a valid double', function() {
            this.validator.formats
                .forEach((format) => {
        ...
        it('does not match an invalid double', function() {
            this.validator.formats
                .forEach((format) => {
